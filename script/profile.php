                ...
                <form class="yourform" id="update-profile" action="<?php $_SERVER['PHP_SELF']; ?>" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control name" name="name"
                            value="<?php echo $row['admin_fullname']; ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" class="form-control email" name="email"
                            value="<?php echo $row['admin_email']; ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Phone</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control address" name="address"
                            value="<?php echo $row['admin_address']; ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Username</label>
                        <input type="text" class="form-control username" name="username"
                            value="<?php echo $row['admin_username']; ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Password</label>
                        <input type="password" class="form-control" name="new_password" value="">
                        <input type="hidden" class="form-control" placeholder=""
                            value="<?php echo $row['admin_password']; ?>" name="old_password" required>
