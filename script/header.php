<?php
    ...
    $result = $db->getResult();
    $site_name = (!empty($result) && isset($result[0]['site_name'])) 
    ? $result[0]['site_name'] 
    : 'Vehicle Parking System';

$site_logo = (!empty($result) && isset($result[0]['site_logo'])) 
    ? $result[0]['site_logo'] 
    : '';
    $currency_format = (!empty($result) && isset($result[0]['currency'])) 
    ? $result[0]['currency'] 
    : '₹';
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header">
                ...
                <a href="dashboard.php" class="navbar-brand p-0 text-dark">
                    <img src="images/site-logo/<?php echo $site_logo; ?>">
                </a>
                <?php } else { ?>
                <h2>
                    <a href="dashboard.php" class="navbar-brand p-0 text-dark">
