            ...
            <div class="card-body position-relative">
                ...
                <form rm class="yourform" id="update-Vehiclecategory" action="" method="post" autocomplete="off">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control cat_name" placeholder="Name" name="cat_name"
                            value="<?php echo $row['category_name']; ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Parking Charges Per Hour</label>
                        <input type="number" class="form-control parking_charge" placeholder="Parking Charges Per Hour"
                            name="parking_charge" value="<?php echo $row['parking_charge']; ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Status</label>
                        <select class="form-control cat_status" name="cat_status" id="">
                            <option value="1" <?php echo $row['category_status'] == '1' ? "selected": ''; ?>>Active
                            </option>

                            <option value="0" <?php echo $row['category_status'] == '0' ? "selected": ''; ?>>Inactive
                            </option>
                        </select>
                    </div>
